...
class SortActivity : BaseMvpActivity<SortContract.IView, SortContract.IPresenter>(), SortContract.IView, OnDialogCallback {
    ...
    companion object {
        fun newInstance() = SortActivity()
    }


    override fun getContentView() = R.layout.activity_sort
    ...
    override fun initView(savedInstanceState: Bundle?) {
        ...
        setOnClickListener(tv_share, tv_share_bottom, tv_search,tv_goback)
    }
...
//                dialog.show(fragmentManager!!, "cateListShare")
    ...
    override fun getCategoryListSuccess(bean: CityBean) {
        ...
        view_pager.run {
            val adapter = MyAdapter(this@SortActivity, mFragmentList)
            setAdapter(adapter)
    ...
    internal class MyAdapter(activity: SortActivity, private val list: List<Fragment>) : FragmentStateAdapter(activity) {
