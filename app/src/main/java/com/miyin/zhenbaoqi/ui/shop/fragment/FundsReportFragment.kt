    ...
    override fun merchantsStatisticsSuccess(bean: ReportBean) {
        bean.data?.run {
            ...
            tv_auction_count.text = SpanUtils()
                    .append("今日成拍：")
                    .append("¥" + FormatUtils.formatNumber(hete_amount  )).setForegroundColor(color)
                    .create()
            ...
            tv_pay_count.text = SpanUtils()
                    .append("今日已付款：")
                    .append("¥" + FormatUtils.formatNumber(pay_amount  )).setForegroundColor(color)
                    .create()
            ...
            tv_refund_count.text = SpanUtils()
                    .append("今日已退款：")
                    .append("¥" + FormatUtils.formatNumber(back_amount  )).setForegroundColor(color)
                    .create()
            ...
            tv_profit_count.text = SpanUtils()
                    .append("今日已收款：")
                    .append("¥" + FormatUtils.formatNumber(put_amount  )).setForegroundColor(color)
                    .create()
            tv_wait_ship_count.text = SpanUtils()
                    .append("今日未发货：")
                    .append("¥" + FormatUtils.formatNumber(wait_amount  )).setForegroundColor(color)
                    .create()
            ...
            tv_wait_confirm_count.text = SpanUtils()
                    .append("今日待确认：")
                    .append("¥" + FormatUtils.formatNumber(waitconf_amount  )).setForegroundColor(color)
                    .create()
            ...
            tv_return_goods_count.text = SpanUtils()
                    .append("今日退货中：")
                    .append("¥" + FormatUtils.formatNumber(refunding_amount  )).setForegroundColor(color)
                    .create()
