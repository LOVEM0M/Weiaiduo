...
public class RoomInfoBean implements Parcelable {
    ...
    public RoomInfoBean(String roomID, String roomInfo, String roomName, String roomCreator, String mixedPlayURL, List<AnchorInfo> anchors) {
        this.roomID = roomID;
    ...
    public static final Parcelable.Creator<RoomInfoBean> CREATOR = new Parcelable.Creator<RoomInfoBean>() {
        @Override
