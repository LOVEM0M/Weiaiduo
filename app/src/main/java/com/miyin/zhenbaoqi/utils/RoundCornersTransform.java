...
public class RoundCornersTransform extends CenterCrop {

    private float mRadius;
    private CornerType mCornerType;
    private static final int VERSION = 1;
    private static final String ID = BuildConfig.APPLICATION_ID + "RoundedCornersTransform." + VERSION;
    ...
    public RoundCornersTransform(float radius, CornerType cornerType) {
        mRadius = radius;
    ...
    public boolean equals(Object o) {
        return o instanceof RoundCornersTransform;
    }
